...
export const PRODUCTS: Product[] = [
  {
    ...
    relatedGuides: [
      { href: "/gear/star-trackers", label: "ポータブル赤道儀の比較" },
  ...
  {
    slug: "polarie-u",
    name: "ビクセン ポラリエU（星空雲台・ポータブル赤道儀）",
    category: "赤道儀",
    role: "主",
    icon: "mount",
    tagline: "本体約575gの軽量ポータブル赤道儀。星景・星野を手軽に追尾でき、Wi-Fiでスマホ設定にも対応。",
    forWho: "三脚＋カメラの星景から一歩進み、軽さ重視で手軽に追尾を始めたい人。",
    pros: [
    ...
    specs: [
      { label: "搭載可能重量", value: "約2.5kg（標準）／6.5kg（別売マルチ雲台ベース使用時）" },
      { label: "追尾モード", value: "恒星時／0.5倍速／太陽／月／カスタム（北半球・南半球）" },
      { label: "電源", value: "単3形電池4本／USB Type-C外部電源・連続約7時間" },
      { label: "本体重量", value: "約575g（電池別）" },
      { label: "極軸望遠鏡", value: "PF-LII（別売）対応／Wi-Fi搭載" },
      { label: "希望小売価格", value: "¥68,200（税込）" },
    ],
    usage: [
      { heading: "1. 三脚に固定して水平を出す", body: "軽量機ほど三脚の安定が効く。雲台のガタを締め、水平を合わせる。" },
      { heading: "2. 北極星に向けて極軸を合わせる", body: "素通しファインダー（別売の極軸望遠鏡でより正確）で北極星方向へ。撮影地の緯度に合わせる。" },
      { heading: "3. モードを選んで追尾", body: "星空メインは恒星時、地上も少し止めたい星景は0.5倍速。追尾でISOを下げて長く露光できる。" },
    ],
    relatedGuides: [
      { href: "/gear/star-trackers", label: "ポータブル赤道儀の比較" },
      { href: "/guide/star-tracker", label: "ポータブル赤道儀は必要か" },
    ...
    purchase: [{ label: "購入先（提携準備中）" }],
    affiliateKeyword: "ビクセン ポラリエU",
    verified: true,
    sourceUrl: "https://www.vixen.co.jp/product/35491_7/",
  },
  {
    slug: "star-adventurer-gti",
    name: "Sky-Watcher スター・アドベンチャーGTi（自動導入ポータブル赤道儀）",
    category: "赤道儀",
    role: "主",
    icon: "mount",
    tagline: "搭載5kg・Wi-Fi内蔵で自動導入(GoTo)。アプリで天体を導入でき、本格的な天体撮影へ踏み出せる上位機。",
    forWho: "星景から天体（星雲・星団）撮影へ進み、目的の天体を自動で導入したい人。",
    pros: [
    ...
    specs: [
      { label: "搭載可能重量", value: "約5kg" },
      { label: "自動導入", value: "Wi-Fi内蔵・SynScanPro対応（GoTo）" },
      { label: "追尾モード", value: "恒星時／太陽時／月時" },
      { label: "電源", value: "単3形電池8本（別売）／外部DC12V（別売）" },
      { label: "本体重量", value: "約2.9kg（ウェイト・電池等を除く）" },
      { label: "極軸望遠鏡", value: "内蔵（明視野照明付き）" },
      { label: "価格", value: "マウント単体 ¥100,375（税込）／三脚セット ¥115,500" },
    ],
    usage: [
      { heading: "1. 設置と極軸合わせ", body: "頑丈な三脚に固定し、内蔵の極軸望遠鏡で北極星を導入して極軸を合わせる。" },
      { heading: "2. アプリで初期設定", body: "SynScanProアプリにWi-Fi接続し、日時・観測地を設定してアライメントを行う。" },
      { heading: "3. 天体を自動導入", body: "アプリから対象を選ぶと自動で導入・追尾。星雲・星団の撮影に踏み出せる。" },
    ],
    relatedGuides: [
      { href: "/gear/star-trackers", label: "ポータブル赤道儀の比較" },
      { href: "/guide/star-tracker", label: "ポータブル赤道儀は必要か" },
    ...
    purchase: [{ label: "購入先（提携準備中）" }],
    affiliateKeyword: "Sky-Watcher スターアドベンチャーGTi",
    verified: true,
    sourceUrl: "https://www.skywatcher.jp/product/equatorial_pedestal/staradventure.html",
  },
  {
    slug: "wide-fast-lens",
  ...
  },
  {
    ...
    relatedGuides: [
      { href: "/gear/tripods", label: "星空向け三脚の比較" },
  ...
  {
    slug: "airy-l100",
    name: "スリック エアリー L100（軽量トラベル三脚）",
    category: "三脚",
    role: "主",
    icon: "tripod",
    tagline: "全高1,543mm・本体約980gの軽量アルミ・トラベル三脚。脚を反転して畳めばコンパクトに運べる。",
    forWho: "とにかく軽く持ち歩きたい人。スマホや軽量ミラーレスでの星景・スナップから始めたい人。",
    pros: [
      "本体約980gと軽く、4段＋脚反転収納で縮長417mmと携帯性が高い",
      "全高1,543mmでアイレベル近くまで伸ばせる",
      "ワンタッチクイックシュー式の自由雲台が付属する",
    ],
    cons: [
      "最大搭載は1.5kg。重い明るいレンズや赤道儀には非力（軽量機材向け）",
      "パイプ径20mm・アルミのため、長秒露光では上位カーボンより微ブレに弱い",
      "星空のガチ運用より、携帯性を最優先したいライト用途向き",
    ],
    specs: [
      { label: "全高", value: "1,543mm（EV下げ 1,309mm）" },
      { label: "縮長", value: "417mm" },
      { label: "パイプ径 / 段数", value: "20mm / 4段" },
      { label: "重量", value: "980g" },
      { label: "最大搭載質量", value: "1.5kg" },
      { label: "材質 / 雲台", value: "アルミ / 自由雲台 SBH-100 DQA（クイックシュー式）" },
      { label: "希望小売価格", value: "¥31,000（税別）" },
    ],
    usage: [
      { heading: "1. 軽量機材で使う", body: "搭載1.5kgが目安。スマホホルダーや軽量ミラーレス＋小型レンズで真価を発揮する。" },
      { heading: "2. 重心を低く・風対策", body: "エレベーターを伸ばさず脚を太い段から出す。フックに荷物を下げて重心を落とすと安定する。" },
      { heading: "3. SSは欲張らない", body: "剛性なりに、微ブレが出る前のSSで。500ルール計算機で上限を確認する。" },
    ],
    relatedGuides: [
      { href: "/gear/tripods", label: "星空向け三脚の比較" },
      { href: "/guide/camp-stargazing", label: "キャンプで星空撮影（軽装備）" },
      { href: "/guide/settings", label: "星空撮影の設定 完全ガイド" },
    ],
    purchase: [{ label: "購入先（提携準備中）" }],
    affiliateKeyword: "スリック エアリー L100",
    verified: true,
    sourceUrl: "https://www.kenko-tokina.co.jp/slik/digital-series/airy/4906752107119.html",
  },
  {
    slug: "leofoto-ls324c",
    name: "Leofoto LS-324C pro（高剛性カーボン三脚）",
    category: "三脚",
    role: "主",
    icon: "tripod",
    tagline: "32mmカーボン4段・耐荷重15kgで本体約1,490g。軽さと高剛性を両立し、赤道儀運用まで見据えられる上位機。",
    forWho: "長秒露光のブレを徹底的に抑えたい人。カメラ＋赤道儀まで載せる前提で、軽くて頑丈な土台が欲しい人。",
    pros: [
    ...
    specs: [
      { label: "全高", value: "1,400mm" },
      { label: "パイプ径 / 段数", value: "最大32mm / 4段" },
      { label: "重量", value: "1,490g" },
      { label: "最大搭載質量", value: "15kg" },
      { label: "開脚角度", value: "4段階" },
      { label: "価格", value: "¥79,200（税込）" },
      { label: "発売", value: "2026年5月" },
    ],
    usage: [
      { heading: "1. 赤道儀の土台に", body: "耐荷重に余裕があるので、ポータブル赤道儀＋カメラを載せても安定する。" },
      { heading: "2. 脚は太い段から", body: "細い段ほどブレやすい。必要な高さは太い脚から確保する。" },
      { heading: "3. ローポジションも活用", body: "4段階開脚で低く構え、前景を入れた星景構図にも対応できる。" },
    ],
    relatedGuides: [
      { href: "/gear/tripods", label: "星空向け三脚の比較" },
      { href: "/guide/star-tracker", label: "ポータブル赤道儀は必要か" },
    ...
    purchase: [{ label: "購入先（提携準備中）" }],
    affiliateKeyword: "Leofoto LS-324C",
    verified: true,
    sourceUrl: "https://dc.watch.impress.co.jp/docs/news/2109661.html",
  },
  {
    slug: "red-headlamp",
